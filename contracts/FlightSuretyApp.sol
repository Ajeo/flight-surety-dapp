...
contract FlightSuretyApp {
    ...
    returns (bool success, uint256 votes)
  {
    ...
    require(
      ...
      "Airline is already operational"
    );
  ...
  function buyInsurance(address airline) external payable requireIsOperational {
    require(
      flightSuretyData.isAirlineOperational(airline),
  ...
  function processFlightStatus(
    ...
    if (
      ...
      flightSuretyData.creditInsurees(airline);
    }
  }
  ...
  function submitOracleResponse(
    ...
    require(
      ...
      "Contract is no more accepting responses"
    );
